...
const SignUpPage = () => {
	...
	return (
		<div className='flex flex-col justify-center py-8 sm:px-6 lg:px-8'>
			...
			>
				<div className='bg-white py-6 px-4 shadow-md sm:rounded-lg sm:px-10'>
					<form onSubmit={handleSubmit} className='space-y-5'>
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									className='text-black block w-full px-3 py-2 pl-10 bg-white border border-gray-300 rounded-md shadow-sm
						...
						<button
							...
							className='w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600
							 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-150 ease-in-out disabled:opacity-50'
							disabled={loading}
						>
							{loading ? (
								<>
