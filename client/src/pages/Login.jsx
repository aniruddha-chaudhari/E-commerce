					...
					<form onSubmit={handleSubmit} className='space-y-6'>
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									className='text-black block w-full px-3 py-2 pl-10 border border-gray-300 rounded-md shadow-sm
						...
						<button
							...
							className='w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm 
							 ...
							 focus:ring-offset-2 focus:ring-indigo-500 transition duration-150 ease-in-out disabled:opacity-50'
							disabled={loading}
						>
							{loading ? (
								<>
